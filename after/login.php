...
<div class="content">
    <h1 class="flex-caption">Welcome back.</h1>
...
<div class="row">
    ...
    <div class="six columns mob-whole">	 
        <label for="contactPassword">Password <span class="required">*</span></label>     						   
            <input name="contactPassword" type="text" id="contactPassword" placeholder="Password"  value="" required/>	      					
    </div>

</div>

<div>
   <input type="submit" class="submit full-width" value="Log In"></input>
   <div id="image-loader">
